...
public class SearchBoxTest extends ChromeRunner {
    ...
    public void SearchCorrectProductTest() {
        searchBoxSteps
                .ClickSearchProducts()
                .EnterProductName(correctProductName)
                .ClickSearchResults();
    ...
    @Test
    @Description("3. Verifying the incorrect product name error text in the search result ")
    @Severity(SeverityLevel.NORMAL)
    public void SearchIncorrectProductTest() {
        searchBoxSteps
                .ClickSearchProducts()
                .EnterProductName(incorrectProductName)
                .ClickSearchResults();
